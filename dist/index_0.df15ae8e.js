...
})({"eMmwI":[function(require,module,exports,__globalThis) {
...
},{}],"biPfD":[function(require,module,exports,__globalThis) {
// 頁面元素選取
// Initialize Firebase
...
let log;
try {
    require("58f1d929b63f526f").then((module)=>{
        log = module.default;
        log.setLevel("info");
...
// Service Worker 註冊
const sw = new URL(require("67733705052c8443"));
if ('serviceWorker' in navigator) {
    const s = navigator.serviceWorker;
    s.register(sw.href, {
        scope: '/Recipe-Organizer-PWA/'
    }).then(()=>log.info('Service Worker Registered for scope:', sw.href, 'with', "file:///assets/js/script.js")).catch((err)=>log.error('Service Worker Error:', err));
}
// Sanitize Input
...
},{"e29d5efd6f5ccc79":"61B45","c9b0ead6a116d2f0":"lgJ39","7kRFs":"7kRFs"}],"61B45":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}],"7wSZb":[function(require,module,exports,__globalThis) {
module.exports = require("f390a3c9e921fcbf").getBundleURL('fh2Ay') + "service-worker.75769289.js" + "?" + Date.now();

},{"f390a3c9e921fcbf":"lgJ39"}]},["eMmwI","biPfD"], "biPfD", "parcelRequire94c2")

//# sourceMappingURL=index_0.df15ae8e.js.map
