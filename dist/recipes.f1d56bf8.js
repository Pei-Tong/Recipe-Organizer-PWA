...
})({"jm882":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "79b9f822f1d56bf8";
"use strict";
...
},{}],"7jDaq":[function(require,module,exports,__globalThis) {
// recipes.js
...
let log;
try {
    require("98a91d7ab2d323b9").then((module)=>{
        log = module.default;
        log.setLevel("info");
...
async function getApiKey() {
    try {
        let snapshot = await (0, _firebaseJs.getDoc)((0, _firebaseJs.doc)((0, _firebaseJs.db), "apikey", "googlegenai"));
...
async function addRecipeToFirestore(recipeData) {
    try {
        const docRef = await (0, _firebaseJs.addDoc)((0, _firebaseJs.collection)((0, _firebaseJs.db), "recipes"), recipeData);
...
function editRecipe(recipeId, recipeData) {
    const recipeRef = (0, _firebaseJs.doc)((0, _firebaseJs.db), "recipes", recipeId);
    (0, _firebaseJs.updateDoc)(recipeRef, recipeData).then(()=>{
...
async function removeRecipe(recipeId) {
    const recipeRef = (0, _firebaseJs.doc)((0, _firebaseJs.db), "recipes", recipeId);
    try {
        await (0, _firebaseJs.deleteDoc)(recipeRef);
...
function toggleFavorite(recipeId, currentFavorite) {
    const recipeRef = (0, _firebaseJs.doc)((0, _firebaseJs.db), "recipes", recipeId);
    (0, _firebaseJs.updateDoc)(recipeRef, {
...
function filterRecipes() {
    ...
    (0, _firebaseJs.getDocs)((0, _firebaseJs.collection)((0, _firebaseJs.db), "recipes")).then((querySnapshot)=>{
        ...
        querySnapshot.forEach((doc)=>{
            ...
            if (matchesIngredient && matchesMeal && matchesUser) renderRecipe(doc.id, recipe);
        });
    }).catch((error)=>{
...
async function getRecipesFromFirestore() {
    const data = await (0, _firebaseJs.getDocs)((0, _firebaseJs.collection)((0, _firebaseJs.db), "recipes"));
    let userData = [];
    data.forEach((doc)=>{
        if (doc.data().email === email) userData.push(doc);
    });
    return userData;
}
...
},{"dc28e567e411a453":"61B45","250d2dd0769080b":"lgJ39","7kRFs":"7kRFs"}],"61B45":[function(require,module,exports,__globalThis) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jm882","7jDaq"], "7jDaq", "parcelRequire94c2")

//# sourceMappingURL=recipes.f1d56bf8.js.map
