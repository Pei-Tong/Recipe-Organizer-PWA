...
console.log("Firebase Auth instance:", (0, _firebaseJs.auth));
// Import loglevel with fallback
let log;
try {
    require("e7f7b3c721cc3410").then((module)=>{
        log = module.default;
        log.setLevel("info");
...
// Service Worker 註冊
const sw = new URL(require("5f83cd24085fb610"));
if ('serviceWorker' in navigator) {
    const s = navigator.serviceWorker;
    s.register(sw.href, {
        scope: '/Recipe-Organizer-PWA/'
    }).then(()=>log.info('Service Worker Registered for scope:', sw.href, 'with', "file:///assets/js/signIn.js")).catch((err)=>log.error('Service Worker Error:', err));
}
// Google SSO 登入邏輯
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    // **生物識別登入按鈕**
    if (biometricLoginButton) biometricLoginButton.addEventListener("click", ()=>{
        log.info("Biometric Login clicked - implement biometric logic here");
    // Placeholder for biometric authentication
    });
    else console.error("Biometric login button not found!");
});

},{"./firebase.js":"38sjH","firebase/auth":"79vzg","e7f7b3c721cc3410":"fWPow","5f83cd24085fb610":"7yIeQ"}],"fWPow":[function(require,module,exports,__globalThis) {
...
},{"e31aa917ffaa520f":"61B45","b9ec04914d9be403":"lgJ39","7kRFs":"7kRFs"}],"61B45":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}],"7yIeQ":[function(require,module,exports,__globalThis) {
module.exports = require("4db4d79c66c44173").getBundleURL('1bKvJ') + "service-worker.75769289.js" + "?" + Date.now();

},{"4db4d79c66c44173":"lgJ39"}]},["lGDp9","99pKn"], "99pKn", "parcelRequire94c2")
