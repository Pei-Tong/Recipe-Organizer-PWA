function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequire94c2;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire94c2=i);var s=i.register;s("47Mwn",function(t,r){e(t.exports,"db",()=>l),e(t.exports,"auth",()=>u),e(t.exports,"getDocs",()=>i("9HrqM").getDocs),e(t.exports,"addDoc",()=>i("9HrqM").addDoc),e(t.exports,"collection",()=>i("9HrqM").collection),e(t.exports,"deleteDoc",()=>i("9HrqM").deleteDoc),e(t.exports,"doc",()=>i("9HrqM").doc),e(t.exports,"getDoc",()=>i("9HrqM").getDoc),e(t.exports,"updateDoc",()=>i("9HrqM").updateDoc),i("fhN3L");var n=i("7xvHX");i("ilpIi");var s=i("9HrqM");i("6AR8M");var o=i("guynj");let a=(0,n.initializeApp)({apiKey:"AIzaSyB7UqECLIMhMXofB0ZsmB-cqSrbRxk53VI",authDomain:"recipe-organizer-pwa.firebaseapp.com",projectId:"recipe-organizer-pwa",storageBucket:"recipe-organizer-pwa.firebasestorage.app",messagingSenderId:"523889521938",appId:"1:523889521938:web:3ff88954b9ba279af22fcb"}),l=(0,s.getFirestore)(a),u=(0,o.o)(a)}),s("fhN3L",function(t,r){e(t.exports,"initializeApp",()=>i("7xvHX").initializeApp),e(t.exports,"registerVersion",()=>i("7xvHX").registerVersion),/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sC{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class sA extends sb{constructor(e,t,r,n,i,s){super(e,t,r,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new sk(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let r=this._document.data.field(sT("DocumentSnapshot.get",e));if(null!==r)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class sk extends sA{data(e={}){return super.data(e)}}class sx{constructor(e,t,r,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new sC(n.hasPendingWrites,n.fromCache),this.query=r}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new sk(this._firestore,this._userDataWriter,r.key,r,new sC(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new A(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(r=>{let n=new sk(e._firestore,e._userDataWriter,r.doc.key,r.doc,new sC(e._snapshot.mutatedKeys.has(r.doc.key),e._snapshot.fromCache),e.query.converter);return r.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new sk(e._firestore,e._userDataWriter,t.doc.key,t.doc,new sC(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(s=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return S()}}(t.type),doc:n,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sR(e){e=iX(e,i1);let t=iX(e.firestore,i4);return(function(e,t,r={}){let n=new k;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iM({next:a=>{s.su(),t.enqueueAndForget(()=>n4(e,o));let l=a.docs.has(r);!l&&a.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&n&&"server"===n.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new it(new to(r.path),s,{includeMetadataChanges:!0,Ta:!0});return n8(e,o)})(await i$(e),e.asyncQueue,t,r,n)),n.promise})(i7(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new sN(e);return new sA(e,i,t._key,n,new sC(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class sN extends sS{constructor(e){super(),this.firestore=e}convertBytes(e){return new se(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new i1(this.firestore,null,t)}}function sD(e){e=iX(e,i0);let t=iX(e.firestore,i4),r=i7(t),n=new sN(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.9f8d3122.js.map
